...
"""
    ...
    def user_options(self, controller):
        ...
        homeline = self.input_and_check("homeline", lambda value : self.llapi.is_homeline_correct(value))
        location = self.input_and_check("location", lambda value : self.llapi.is_location_correct(value))
